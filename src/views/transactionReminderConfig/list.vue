<template>
  <div class="border">
    ...
    <el-table ref="transactionReminderConfigTable" :data="tableData" border stripe highlight-current-row
      ...
      <el-table-column prop="configType" label="提示类型" header-align="center" align="center" width="204" :formatter="formatConfigTypes"/>
      <el-table-column prop="configType" label="图片链接" header-align="center" align="center" width="297" :formatter="configTypeImages"/>
      <el-table-column prop="hint" label="提示语" header-align="center" align="center" width="248" />
      <el-table-column prop="remark" label="备注" header-align="center" align="center" width="214"/>
