<template>
  <div class="border" style="width: 100%">
    <el-form :inline="true" :model="bannerForm" :rules="rules" ref="bannerForm" label-width="100px"
      ...
      <el-row style="margin: 0 0 10px 10px">
        <el-col :span="24">
          <span style="margin-right: 10px">配置banner</span><el-button class="el-icon-plus" style="color: white;background-color: #009688;" @click="addBannerDetailsTableRows"></el-button>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="6">
