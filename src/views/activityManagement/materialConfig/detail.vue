<template>
  <div class="border">
    <el-dialog title="物料详情" :visible.sync="ifshow" @open="openDialog" :before-close="closeDialog" width="90%" style="margin-top: -80px">
...
export default {
  ...
  methods: {
    openDialog () {
      this.entryForm = clone(this.entity)
    },
    closeDialog () {
    ...
    handleFilesChange: function (file, fileList) {
      if (!this.$permission.hasPermission('MATERIAL_CONFIG_UPDATE')) {
        return
      }
