<template>
  <div class="border" style="width: 100%">
    <el-dialog title="新增Android截流配置" :visible.sync="ifshow" @open="openDialog" :before-close="closeDialog">
      <el-form :inline="true" :model="appClosureSwitchForm" :rules="rules" ref="appClosureSwitchForm" label-width="100px"
        ...
        <el-row type="flex" justify="center" style="margin-top: 10px">
          <el-col :span="40">
            <el-form-item>
              <el-button type="primary" @click="saveAppClosureSwitch">提交</el-button>
...
export default {
  ...
  methods: {
    openDialog () {
      this.appClosureSwitchForm = clone(this.appClosureSwitchInitForm)
    },
    closeDialog () {
